...
const openapi = fromHono(app, {
	...
	schema: {
		...
		servers: [
			{
				url: "https://cors.ix.workers.dev/api.xserver.ne.jp/v1/server/{servername}",
...
// Register XServer API mock (OpenAPI docs at root, routing at /v1/server/:servername)
openapi.route("/", xserverRouter);
